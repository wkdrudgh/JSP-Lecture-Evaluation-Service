...
<%
	...
	if(request.getParameter("pagaNumber") != null){
		try{
			pagaNumber = Integer.parseInt(request.getParameter("pagaNumber"));			
		}catch(Exception e){
...
%>
			...
			<form action="./index.jsp" method="get" class="form-inline my-2 my-lg-0">
				<input type="text" name="search" class="form-control mr-sm-2" type="search" placeholder="내용을 입력하세요." aria-lable="Search">
...
<%
	...
	evaluationList = new EvaluationDAO().getList(lectureDivide, searchType, search, pagaNumber);
